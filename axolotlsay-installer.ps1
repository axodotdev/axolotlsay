...
The installer for axolotlsay 0.3.3

.DESCRIPTION

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/axodotdev/axolotlsay/releases/download/v0.3.3
...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/axodotdev/axolotlsay/releases/download/v0.3.3',
...
if ($env:INSTALLER_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrl = "$installer_base_url/axodotdev/axolotlsay/releases/download/v0.3.3"
}

$receipt = @"
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.25.2-prerelease.0"},"source":{"app_name":"axolotlsay","name":"axolotlsay","owner":"axodotdev","release_type":"github"},"version":"0.3.3"}
"@
